...
![새로 만들기](../assets/new.svg) - [AEM 상점](overview.md#supported-architecture)에 대한 지원이 추가되었습니다.
...
![수정](../assets/fix.svg) **[!UICONTROL Refresh]** 단추가 Experience Platform의 사용자 지정 특성을 백 오피스 컬렉터에 올바르게 동기화하지 못하는 문제를 해결했습니다.
