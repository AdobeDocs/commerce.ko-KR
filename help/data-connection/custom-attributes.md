...
1. [!DNL Data Connection] 확장을 활성화하기 위한 필수 구성 요소를 완료했습니다. [필수 구성 요소](overview.md#prerequisites)를 참조하십시오.
1. [사용자 지정 순서 특성](#add-custom-attributes-to-orders)을 구성했습니다.
