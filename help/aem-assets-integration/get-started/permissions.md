...
* 클라우드 또는 온프레미스의 Adobe Commerce에서 IMS는 선택 사항입니다.
  ...
  [Commerce에 대해 IMS를 사용하도록 설정](https://experienceleague.adobe.com/ko/docs/commerce-admin/start/admin/ims/adobe-ims-config){target=_blank}에서는 향상된 구성 UI(자산 선택기, 자동으로 채워진 드롭다운)를 제공하지만, **프로그램 ID** 및 **환경 ID**&#x200B;를 수동으로 입력하여 IMS 없이 통합을 구성할 수 있습니다.
...
>[!NOTE]
>
> Commerce 및 AEM Assets에도 사용자를 추가해야 합니다. 전체 설정에 대해서는 _사용자 및 Identity Management_ 안내서에서 [AEM Assets 또는 제품 비주얼에 사용자 추가](https://experienceleague.adobe.com/ko/docs/commerce/cloud-service/user-management#add-a-user-to-aem-assets-or-product-visuals){target=_blank}를 참조하십시오.
...
1. [Commerce에서 Adobe IMS를 사용하도록 설정](https://experienceleague.adobe.com/ko/docs/commerce-admin/start/admin/ims/adobe-ims-config){target=_blank}하여 Commerce 관리자가 IMS 인증을 사용하고 사용자의 Admin Console 제품 프로필을 읽을 수 있도록 합니다.

1. 자산 선택기에 대한 사용자 지정 IMS 클라이언트 ID를 요청하려면 [지원 티켓을 엽니다](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case).
