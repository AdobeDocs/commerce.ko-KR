...
IMS 인증은 기본적으로 활성화되어 있습니다. 사용자에게 AEM Assets 배달 제품 프로필이 없는 경우 [Adobe Admin Console](https://adminconsole.adobe.com/)의 **AEM DM OpenAPI 사용자 - 배달** 제품 프로필 또는 **작성자** 제품 프로필(예: `<environment-name> - author - <program-id> - <environment-id>`)에 사용자를 대체 항목으로 추가합니다.
...
1. [Commerce에서 Adobe IMS를 사용하도록 설정](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/ims/adobe-ims-config.html){target=_blank}하여 Commerce 관리자가 IMS 인증을 사용하고 사용자의 Admin Console 제품 프로필을 읽을 수 있도록 합니다.
