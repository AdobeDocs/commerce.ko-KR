...
1. [Commerce에서 Adobe IMS를 사용하도록 설정](https://experienceleague.adobe.com/docs/commerce-admin/start/admin/ims/adobe-ims-config.html?lang=ko){target=_blank}하여 Commerce 관리자가 IMS 인증을 사용하고 사용자의 Admin Console 제품 프로필을 읽을 수 있도록 합니다.
