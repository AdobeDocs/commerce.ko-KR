...
* AEM as a Cloud Service에서 [Dynamic Media with OpenAPI capabilities](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis)을(를) 활성화하려면 다음 정보가 포함된 Adobe 지원 티켓을 제출하십시오.
