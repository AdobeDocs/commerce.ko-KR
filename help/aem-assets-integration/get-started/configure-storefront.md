...
Edge Delivery Services에서 제공하는 Commerce Storefront와 함께 AEM Assets을 사용하는 방법에 대한 자세한 내용은 *Adobe Commerce Storefront* 설명서의 [AEM Assets 통합](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/aem-assets-configuration/) 주제에 설명된 Storefront 구성을 완료하십시오.
