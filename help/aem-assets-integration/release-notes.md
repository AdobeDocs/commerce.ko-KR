...
[!BADGE 지원]{type=Informative tooltip="지원됨"} Adobe Commerce 버전 2.4.5 이상 릴리스.

![해결된 문제](../assets/fix.svg)<!-- Issue ACAP-1169 --> **미니 카트**, **카트** 및 **체크 아웃** 페이지에서 AEM Assets 통합을 활성화한 후 제품 썸네일 이미지가 일관되지 않게 표시되는 문제를 해결했습니다. 이제 페이지를 새로 고친 후에도 제품 이미지가 모든 페이지에서 일관되게 렌더링됩니다.
