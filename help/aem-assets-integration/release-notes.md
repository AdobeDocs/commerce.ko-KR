...
![문제 해결](../assets/fix.svg)<!-- Issue ACAP-1223 --> 구성 가능한 제품에 대한 관리자에서 중복된 제품 이미지 역할 집합이 표시되는 문제를 해결했습니다.

![문제 해결](../assets/fix.svg)<!-- Issue CCSAAS-4769 --> 업그레이드 또는 데이터 패치 중 무결성 제약 조건 위반을 초래하는 `UpdateAssetImageRolesDataPatch`의 문제를 해결했습니다.
