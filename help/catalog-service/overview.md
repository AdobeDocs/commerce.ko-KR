...
>[!NOTE]
>
>Adobe Commerce Optimizer 또는 Adobe Commerce Optimizer 커넥터와 함께 구성 가능한 카탈로그를 사용하여 카탈로그를 구현하는 경우 [Adobe Commerce Optimizer 안내서](../optimizer/overview.md#architecture) 및 머천다이징 서비스 개발자 안내서를 참조하십시오.
