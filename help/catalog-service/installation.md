...
카탈로그 서비스를 설치하여 [카탈로그 서비스 GraphQL API](https://developer.adobe.com/commerce/webapi/graphql/schema/catalog-service/)를 사용하여 Commerce 인스턴스에서 제품 데이터를 요청하고 받습니다. 카탈로그 서비스는 repo.magento.com 저장소에서 작성기 PHP 메타패키지로 제공됩니다.
...
>
>Adobe Commerce Optimizer을 사용하는 Commerce 상점 구현의 경우 [머천다이징 서비스 개발자 안내서](https://developer-stage.adobe.com/commerce/services/optimizer/)를 참조하십시오.
...
Commerce 관리에서 [데이터 관리 대시보드](https://experienceleague.adobe.com/ko/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard)를 사용하여 동기화 프로세스를 모니터링할 수 있습니다. [Commerce CLI](../data-export/data-export-cli-commands.md) 및 [로그](../data-export/troubleshooting/logging.md)를 사용하여 프로세스를 관리하고 문제를 해결하십시오.
