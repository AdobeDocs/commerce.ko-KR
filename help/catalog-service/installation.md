...
샌드박스 엔드포인트에서 모든 로드 테스트를 수행합니다. 부하 테스트를 시작하기 전에 [지원 티켓](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-customer-support-experience#create-a-support-ticket-with-experience-league)을 제출하여 서비스 팀이 추가 서버 트래픽을 예측할 수 있도록 합니다.
...
1. [데이터 관리 대시보드](https://experienceleague.adobe.com/ko/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard)에서 초기 데이터 동기화를 수행합니다.
