...
Commerce 관리에서 [데이터 관리 대시보드](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard)를 사용하여 동기화 프로세스를 모니터링할 수 있습니다. [Commerce CLI](../data-export/data-export-cli-commands.md) 및 [로그](../data-export/troubleshooting/logging.md)를 사용하여 프로세스를 관리하고 문제를 해결하십시오.
