...
GraphQL 쿼리에서 관리자의 Adobe Commerce 서비스 커넥터 구성에 추가한 공개 API 키를 포함하여 여러 HTTP 헤더를 지정해야 합니다. 자세한 내용은 [Storefront Services GraphQL](https://developer.adobe.com/commerce/webapi/graphql/schema/) 설명서를 참조하십시오.
...
[!DNL Catalog Service] 데이터 동기화에 대한 자세한 내용은 [데이터 관리 대시보드](https://experienceleague.adobe.com/ko/docs/commerce-admin/systems/data-transfer/data-dashboard)를 참조하세요.
