...
* 관리자 - 세 가지 유형의 관리자가 있습니다.
   ...
   * [제품 관리자](#add-a-product-admin) - 제품 관리자는 [에서 ](#add-users-and-admins)제품에 대한 사용자, 역할 및 권한을 관리[!DNL Adobe Admin Console]하고 [Commerce 관리자의 사용자를 관리](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/user-accounts/permissions-users-all#create-a-user){target="_blank"}할 수 있습니다.
...
AEM Assets 사용자가 제공하는 Adobe Experience Manager Assets 및 제품 비주얼에는 다음 설정이 필요합니다.
