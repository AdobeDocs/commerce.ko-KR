...
* [!BADGE SaaS만 해당]{type=Positive url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="Adobe Commerce as a Cloud Service 및 Adobe Commerce Optimizer 프로젝트에만 적용됩니다(Adobe 관리 SaaS 인프라)."} **SaaS(신규 - [!DNL Adobe Commerce as a Cloud Service])**: Adobe에서 핵심 응용 프로그램, 인프라 및 업데이트를 완전히 관리합니다. 판매자는 확장성 지점(API, 앱 빌더, UI SDK)을 통한 사용자 지정에 대한 포커스. 핵심 애플리케이션 코드가 잠겨 있습니다.
...
* [엣지 딜리버리 서비스](https://experienceleague.adobe.com/developer/commerce/storefront/)
