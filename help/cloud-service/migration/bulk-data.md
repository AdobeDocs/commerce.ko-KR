...
>[!IMPORTANT]
>
>구성 설정은 자동으로 가져오지 않습니다. 데이터 마이그레이션 프로세스를 시작하기 전에 [!DNL Commerce Admin]에서 현재 카탈로그 구성 설정을 참고하십시오. 그런 다음 대상 [!DNL Adobe Commerce as a Cloud Service] 환경에서 동일한 구성을 구현합니다.
