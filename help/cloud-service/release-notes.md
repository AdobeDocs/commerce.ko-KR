...
[Source 단위 가용성](https://experienceleague.adobe.com/en/docs/commerce-admin/inventory/configuration/global-options)을 사용하도록 설정합니다. <!-- ACCS-933 -->
...
GraphQL 돌연변이 및 REST 끝점을 포함한 자세한 정보는 [Storefront 호환성 B2B 패키지 변경 로그](https://experienceleague.adobe.com/developer/commerce/storefront/releases/changelog/#storefront-compatibility-b2b-package-v1-0-24-2026-07-20)를 참조하십시오.
...
[**무료 선물** 장바구니 가격 규칙](https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/promotions/cart-rules/price-rules-cart-free-gift))을 이제 [!DNL Commerce Admin]에서 상점 앞에 사용할 수 있습니다.
<!-- AC-17678 -->
