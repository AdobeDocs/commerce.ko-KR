...
다음 항목은 2026년 4월 16일에 프로덕션 환경에 릴리스됩니다.

>[!BEGINSHADEBOX]

### 웹후크를 사용하여 사용자 정의 견적 합계 구현

이제 `plugin.magento.out_of_process_totals_collector.api.get_total_modifications.execute`에서 [ ](https://developer.adobe.com/commerce/extensibility/webhooks/)webhook[!DNL Adobe Commerce as a Cloud Service]을(를) 사용할 수 있습니다. 프로세스 외부 확장성을 통해 사용자 정의 견적 합계 수정 사항을 구현하는 데 사용합니다. <!-- CEXT-5896 -->
...
[전자 메일 미리 알림 규칙](https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/communications/email-reminders/email-reminder-rules)은(는) 이제 원래 트리거 조건이 더 이상 적용되지 않은 후에 동일한 규칙을 고객에게 다시 적용할 수 있도록 하는 선택적 규칙 재사용 가능성 설정을 지원합니다.
...
[[!DNL Payment Services]](https://experienceleague.adobe.com/en/docs/commerce/payment-services/get-started/production)을(를) 활성화한 경우 이제 [에서 ](../payment-services/payments-home.md)대시보드 UI[!DNL Commerce Admin]을(를) 사용할 수 있으며, 결제 거래를 보고 관리하기 위해 [거래 보고서](../payment-services/reporting.md#transactions-report-view)에 액세스할 수 있습니다. <!-- PAY-6510 -->
...
이제 `plugin.out_of_process_shipping_methods.api.shipping_rate_repository.get_rates`의 관리 웹후크 목록에서 [!DNL Adobe Commerce as a Cloud Service] 웹후크를 사용할 수 있습니다. [사용자 지정 배송 방법](https://developer.adobe.com/commerce/extensibility/starter-kit/checkout/shipping-use-cases/#shipping-methods)을 구현하는 데 사용합니다. <!-- ACCS-478 -->
