...
[전자 메일 미리 알림 규칙](https://experienceleague.adobe.com/ko/docs/commerce-admin/marketing/communications/email-reminders/email-reminder-rules)은(는) 이제 원래 트리거 조건이 더 이상 적용되지 않은 후에 동일한 규칙을 고객에게 다시 적용할 수 있도록 하는 선택적 규칙 재사용 가능성 설정을 지원합니다.
...
[[!DNL Payment Services]](https://experienceleague.adobe.com/ko/docs/commerce/payment-services/get-started/production)을(를) 활성화한 경우 이제 [에서 &#x200B;](../payment-services/payments-home.md)대시보드 UI[!DNL Commerce Admin]을(를) 사용할 수 있으며, 결제 거래를 보고 관리하기 위해 [거래 보고서](../payment-services/reporting.md#transactions-report-view)에 액세스할 수 있습니다. <!-- PAY-6510 -->
