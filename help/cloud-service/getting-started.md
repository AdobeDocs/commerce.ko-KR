...
* **[[!DNL Adobe Developer App Builder]](https://developer.adobe.com/app-builder/)** - [통합 스타터 키트](https://developer.adobe.com/commerce/extensibility/starter-kit/integration/) 및 [[!DNL API Mesh]](https://developer.adobe.com/graphql-mesh-gateway/)와 같은 다른 확장성 도구와 함께 [!DNL App Builder]을(를) 사용하여 사용자 지정 통합을 빌드합니다.
...
1. **시스템 관리자**: [사용자 추가 및 역할 할당](user-management.md#add-users)
...
>[!NOTE]
>
>인스턴스를 만들려면 먼저 조직의 제품 관리자 또는 시스템 관리자가 사용자를 [!DNL Adobe Commerce as a Cloud Service] 제품의 사용자로 추가해야 합니다. 자세한 내용은 [사용자 및 관리자 추가](./user-management.md#add-users)를 참조하십시오.
...
인스턴스를 만들었으므로 [!DNL Edge Delivery Services]에서 제공하는 [상점 설치](storefront.md)를 준비했습니다.
