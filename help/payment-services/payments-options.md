...
* **고급** - 현재 [완전히 지원되는 국가](../payment-services/payments-options.md)에서 사용 가능한 모든 [결제 옵션](compatibility.md#standard-vs-advanced-payment-services-experience)을 사용할 수 있습니다. 실시간 결제를 활성화하려면 온보딩 중에 [고급 온보딩 옵션](../payment-services/production.md#advanced-onboarding)을 선택하세요.
...
[!DNL Pay Later]설정[&#x200B; 구성을 업데이트하여 &#x200B;](configure-admin.md#paypal-payment-buttons) 메시지를 사용하지 않도록 설정하거나 사용하도록 설정하는 방법에 대해 알아봅니다.

##### 선택 사항입니다. 나중에 결제 메시지 구성

**나중에 결제**&#x200B;에 대한 [메시지 구성](configure-admin.md#paypal-payment-buttons)을 통해 판매자는 이 결제 옵션의 기본 스타일을 수정할 수 있습니다. **[!UICONTROL Display Pay Later Message]**&#x200B;설정`Yes` 구성에서 [을(를) &#x200B;](configure-admin.md#paypal-payment-buttons)(으)로 설정하면 **[!UICONTROL Configure Messaging]**&#x200B;의 스타일을 설정할 수 있도록 **[!UICONTROL PayPal Pay Later messaging]** 모달 단추가 표시됩니다.
...
1. _섹션에서_ 옵션을 **[[!UICONTROL Show PayPal Credit and Debit card button]](configure-admin.md#paypal-payment-buttons)**&#x200B;끄기&#x200B;_[!UICONTROL Payment buttons]_&#x200B;합니다.

**기존 신용 카드 공급자 _및_ PayPal 결제 단추**&#x200B;로 결제를 캡처하려면:

1. 스토어가 [프로덕션 모드](configure-admin.md#general-configuration)에 있는지 확인하십시오.
1. [원하는 PayPal 결제 단추를 구성하십시오](configure-admin.md#paypal-payment-buttons).
1. _섹션에서_ 옵션을 **[[!UICONTROL PayPal Show Credit and Debit card button]](configure-admin.md#paypal-payment-buttons)**&#x200B;끄기&#x200B;_[!UICONTROL Payment buttons]_&#x200B;합니다.
1. _섹션에서_ 옵션을 **[[!UICONTROL Show on checkout page]](configure-admin.md#credit-card-fields)**&#x200B;해제&#x200B;_[!UICONTROL Credit card fields]_&#x200B;하고 [기존 신용 카드 공급자 계정](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/payments/payments.html#payments)을 사용하세요.
...
* **PayPal 및 나중에 결제**: **[!UICONTROL Show buttons at start of checkout]** PayPal 결제 단추[&#x200B; 설정에서 &#x200B;](configure-admin.md#paypal-payment-buttons)을(를) 사용하도록 설정합니다.

* **Apple 결제**: **[!UICONTROL Show Apple Pay at start of checkout]** Apple 결제[&#x200B; 설정에서 &#x200B;](configure-admin.md#apple-pay)을(를) 활성화합니다.

* **Google 결제**: **[!UICONTROL Show Google Pay at start of checkout]** Google 결제[&#x200B; 설정에서 &#x200B;](configure-admin.md#google-pay)을(를) 활성화합니다.
