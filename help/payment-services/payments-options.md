...
1. _섹션에서_ 옵션을 **[[!UICONTROL Show PayPal Credit and Debit card button]](configure-admin.md#paypal-payment-buttons)**&#x200B;끄기&#x200B;_[!UICONTROL Payment buttons]_합니다.

**기존 신용 카드 공급자 _및_ PayPal 결제 단추**&#x200B;로 결제를 캡처하려면:

1. 스토어가 [프로덕션 모드](configure-admin.md#general-configuration)에 있는지 확인하십시오.
1. [원하는 PayPal 결제 단추를 구성하십시오](configure-admin.md#paypal-payment-buttons).
1. _섹션에서_ 옵션을 **[[!UICONTROL PayPal Show Credit and Debit card button]](configure-admin.md#paypal-payment-buttons)**&#x200B;끄기&#x200B;_[!UICONTROL Payment buttons]_합니다.
