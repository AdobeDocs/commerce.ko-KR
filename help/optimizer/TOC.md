...
- 결과 관리 {#manage-results}
  ...
  - {hide-from-toc}[일치 및 순위 검색](./manage-results/search-relevance-matching.md)
...
- 스토어 설정 {#setup}
  - [카탈로그 소스](./setup/catalog-sources.md)
  - [카탈로그 보기](./setup/catalog-view.md)
  - [비공개 카탈로그 보기](./setup/private-catalog-view.md)
  - [제한된 액세스 키](./setup/restricted-access-keys.md)
  - [카탈로그 레이어](./setup/catalog-layer.md)
  - [정책](./setup/policies.md)
  - [가격 장부](./setup/pricebooks.md)
  - [제품 시각화](./setup/product-visuals.md)
  - [데이터 동기화](./setup/data-sync.md)
  - [의미 체계 검색](./setup/semantic-search.md)
  - 이벤트 {#events}
...
- 시작 사이트 {#launch}
  - [시작 체크리스트](./launch/launch-checklist.md)
- 개발자 리소스 {#developer}
