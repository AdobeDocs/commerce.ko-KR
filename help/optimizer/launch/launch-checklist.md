...
▢ 인스턴스가 [출시 준비](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/launch/checklist) 요구 사항을 충족합니다.
...
▢ 문서 제목 메타데이터가 키 페이지(특히 PDP 및 PLP)에 대해 있습니다. _Adobe Commerce 상점_ 설명서에서 [SEO 메타데이터](https://experienceleague.adobe.com/developer/commerce/storefront/setup/seo/metadata/?lang=ko){target="_blank"}를 참조하십시오.
▢개의 PDP에 [메타데이터 및 구조화된 데이터](https://experienceleague.adobe.com/developer/commerce/storefront/setup/seo/metadata/?lang=ko){target="_blank"}(예: JSON-LD)가 포함됩니다.
...
키 페이지에 대해 ▢ 미리 렌더링이 설정되어 있습니다. _AEM 상점_ 설명서에서 [Adobe Commerce을 위한 사전 렌더링](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/aem-prerender/?lang=ko){target="_blank"}을 참조하십시오.
...
▢ [Commerce 구성](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/commerce-configuration/?lang=ko){target="_blank"}의 `environment` analytics 매개 변수는 개발 중 `"Testing"`이고 Go-Live 시 `"Production"`입니다. [Analytics 계측](https://experienceleague.adobe.com/developer/commerce/storefront/setup/analytics/instrumentation/?lang=ko){target="_blank"}을 참조하십시오.
...
▢ 제품 시각적 개체 통합이 프로비저닝되었습니다. [AEM Cloud Service 액세스 개요](https://experienceleague.adobe.com/ko/docs/experience-manager-learn/cloud-service/accessing/overview#)를 참조하십시오.
...
▢ [다중 저장소 설정](https://experienceleague.adobe.com/developer/commerce/storefront/setup/seo/indexing/?lang=ko#multi-store-setups){target="_blank"}의 경우 카탈로그 서비스 및 [!DNL Live Search] 요청에는 저장소별 캐시 버스터(예: 쿼리 매개 변수 또는 CDN 규칙)가 포함됩니다.
