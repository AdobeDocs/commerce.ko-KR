...
Commerce Optimizer 커넥터를 통해 업스트림 데이터 소스로 Adobe Commerce을 사용하는 프로젝트의 경우 Commerce 관리자의 [데이터 피드 동기화 상태 페이지](../../data-export/data-synchronization.md)에서 데이터 내보내기 프로세스를 모니터링하고 다시 동기화 작업을 시작할 수 있습니다.
