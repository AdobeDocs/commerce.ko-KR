...
조직이 프로비저닝된 시기를 기준으로 [!DNL Adobe Commerce Optimizer]에 제품 관리자 사용자를 추가하는 방법은 두 가지가 있습니다. 조기 액세스 조직에서는 제품 관리자 역할이 할당된 각 사용자에게 조직의 모든 인스턴스를 관리할 수 있는 권한이 있습니다. 2025년 10월 13일 이후에 프로비저닝된 GA(General Availability) 조직에서는 사용자를 특정 인스턴스에 대한 제품 관리자로 할당할 수 있습니다. 제품 관리자 사용자가 로그인하면 관리할 권한이 있는 인스턴스만 표시됩니다.
...
>[!NOTE]
>
>제품 관리자와 시스템 관리자만 [!DNL Adobe Commerce Optimizer] 제품에 사용자와 개발자를 추가할 수 있습니다.
