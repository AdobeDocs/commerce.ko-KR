...
- 지능적인 등급이 올바르게 작동하도록 하려면 검색 또는 필터링(패싯)에 사용되는 [제품 특성](https://developer-stage.adobe.com/commerce/services/composable-catalog/data-ingestion/api-reference/#tag/Metadata)에 대한 **검색 가중치**&#x200B;가 `5` 이하인지 확인하십시오.
