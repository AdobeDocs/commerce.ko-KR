...
**재킷** ![양방향 선택기](../../assets/two-way.png) 코트
**바지** ![양방향 선택기](../../assets/two-way.png) 슬랙스 ![양방향 선택기](../../assets/two-way.png) 바지
...
**스웨트 셔츠** ![단방향 선택기](../../assets/one-way.png) 후드
**바지** ![단방향 선택기](../../assets/one-way.png) capris ![단방향 선택기](../../assets/one-way.png) 종아리 길이 바지 ![단방향 선택기](../../assets/one-way.png) 페들 푸셔

## 다중 단어 동의어 동작

여러 단어 동의어의 경우 [!DNL Adobe Commerce Optimizer]은(는) 동의어를 구문으로 간주합니다. 예를 들어 양방향 동의어 **식사 테이블** ![양방향 선택기](../../assets/two-way.png) **주방 테이블** ![양방향 선택기](../../assets/two-way.png) **식사 테이블**&#x200B;을 만드는 경우 [!DNL Adobe Commerce Optimizer]은(는) **식사 테이블** 또는 **주방 테이블** 또는 **식사 테이블**&#x200B;의 발생 여부를 검색할 수 있도록 설정된 모든 필드를 검색합니다.
...
이전과 같이 용어를 개별적으로 검색하려는 경우 [지원 티켓을 만들 수 있습니다](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide). 수요가 충분하면 [!DNL Adobe Commerce Optimizer]은(는) 향후 릴리스에서 이 기능을 제품에 추가하는 것을 고려합니다.
