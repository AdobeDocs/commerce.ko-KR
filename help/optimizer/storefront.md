...
이 튜토리얼에서는 [ 인스턴스의 데이터를 사용하는 강력하고, 확장 가능하며, 안전한 Adobe Commerce 상점 만들기를 위해 Edge Delivery Services에서 제공하는 ](https://experienceleague.adobe.com/developer/commerce/storefront/get-started/)Commerce 상점[!DNL Adobe Commerce Optimizer]을(를) 설정하고 사용하는 방법을 보여 줍니다.
