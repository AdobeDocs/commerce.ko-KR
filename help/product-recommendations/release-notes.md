...
릴리스 노트는 다음 [!DNL Product Recommendations]개 모듈에 대한 업데이트를 설명합니다.
...
[제품 지원에 대해 자세히 알아보세요](https://experienceleague.adobe.com/en/docs/commerce-operations/release/product-availability).
...
![수정](../assets/fix.svg)(**[!DNL Adobe Commerce as a Cloud Service]**&#x200B;만 해당) [제품 미리 보기 패널](create.md#preview-recommendations)을 업데이트했습니다. 이제 미리 보기를 위해 SKU가 필요한 권장 사항 유형(예: 교차 판매, 상향 판매 및 유사성 기반 권장 사항)에만 표시됩니다. 다른 유형의 경우 미리보기가 숨겨집니다. 미리 보기가 지원되지 않을 때 **최근에 본 항목** 및 **추천한 항목**&#x200B;과 같이 개인화된 형식에서 메시지를 표시합니다.
...
장바구니 페이지의 [!DNL Product Recommendations] 장치에서 장바구니에 추가한 ![버그](../assets/bug.svg) 제품은 장바구니 페이지가 다시 로드될 때 권장 제품 목록에서 제거되지 않습니다.
...
### magento/product-recommendations 6.8.0
...
![새로 만들기](../assets/new.svg) [제품 권장 사항 작업 영역](workspace.md)에서 기본이 아닌 저장소 보기에서 만든 [PageBuilder 권장 사항 단위](page-builder.md)에 대한 지표를 표시할 수 있는 지원이 추가되었습니다.
...
![새로 만들기](../assets/new.svg) 이미지 크기 조정이 참조 표시 템플릿에서 보다 일관되게 처리되도록 이미지 크기 조정을 개선했습니다
...
![수정](../assets/fix.svg) 외부 장바구니 추가 이벤트를 보내는 문제를 해결했습니다.
