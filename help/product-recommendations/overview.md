...
[!DNL Product Recommendations] [Adobe AI](https://business.adobe.com/kr/ai.html) 및 종합 구매자 행동 및 카탈로그 데이터에 대해 훈련된 머신 러닝을 사용하여 Adobe Commerce 상점 첫 화면에서 개인화된 추천을 제공합니다. 이 개요에서는 서비스 제한(HIPAA 포함), 데이터 개인정보 보호, 추천 단위 배치, 상점 구현 옵션, 제품 관계 통합 및 카탈로그 데이터 보존에 대해 설명합니다.
...
카탈로그 데이터가 비활성화되면 복원하려면 &quot;[!DNL Product Recommendations] 다시 활성화&quot;라는 제목을 사용하여 [지원 요청을 제출](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#experience-league-start-page)하고 환경 ID를 포함하세요. 카탈로그 데이터는 2시간 이내에 복원해야 합니다.
