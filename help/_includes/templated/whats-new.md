...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>피드 잠금으로 동시 동기화 충돌을 방지하는 방법과 Commerce 데이터 내보내기 로그(<code>commerce-data-export.log</code>)에 포함된 일반 건너뛰기 메시지를 해석하는 방법을 설명하기 위해 SaaS 데이터 내보내기를 위한 <a href="https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/feed-lock-mechanism">피드 잠금 메커니즘</a>을 추가했습니다.</p>
</td>
      <td>
        새 주제
      </td>
