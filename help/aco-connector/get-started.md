...
1. **[!DNL Edge Delivery Services]**&#x200B;에서 Commerce 상점 설정
   ...
   [!DNL Commerce Optimizer] 인스턴스에 상점 전선을 연결하고 개인화된 상거래 경험을 게재하려면 [상점 전선의 설정 설명서](https://experienceleague.adobe.com/developer/commerce/storefront/setup/){target="_blank"}를 따르십시오.
