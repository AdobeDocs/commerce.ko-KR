...
커넥터가 [!DNL Commerce Optimizer] [!DNL Catalog Data Ingestion API]에 여러 피드 형식을 제출합니다. 아래 표는 [!DNL Adobe Commerce]에 끝점, 배치 제한, 인덱서 이름 및 피드 테이블이 있는 각 피드를 나열합니다.
...
각 피드에 대한 필드 수준 매핑 세부 정보는 [피드 [!DNL Commerce Optimizer Connector] 2&rbrace;에 대한 필드 매핑을 참조하십시오.](field-mapping.md)
