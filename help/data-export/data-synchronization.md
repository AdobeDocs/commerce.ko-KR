...
>[!NOTE]
>
>데이터 관리 대시보드는 라이브 검색, 제품 권장 사항 또는 카탈로그 서비스가 설치된 경우에만 사용할 수 있습니다. 이러한 서비스가 있거나 [Adobe Commerce Optimizer 커넥터](../aco-connector/overview.md)가 설치된 경우 데이터 피드 동기화 상태 대시보드를 사용할 수 있습니다.
