...
구성 또는 타사 확장과 관련이 없는 오류가 표시되면 가능한 많은 정보가 포함된 [지원 티켓](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide)을 제출하십시오.

### 카탈로그 동기화 문제 해결 {#resolvesync}

데이터 불일치, 동기화 실행 안 함, 동기화 실패 상태 등 카탈로그 동기화 문제에 대한 문제 기반 문제 해결은 [시나리오 문제 해결](troubleshooting-scenarios.md)을 참조하십시오.
...
>[!MORELIKETHIS]
>
> - [시나리오 문제 해결](troubleshooting-scenarios.md) - 카탈로그 동기화 문제 및 데이터 불일치를 해결합니다.
> - [로그 코드 참조](log-codes-reference.md) — 내보내기 로그 코드를 조회합니다.
> - [Commerce CLI를 사용하여 피드 동기화](../data-export-cli-commands.md) - 타깃팅된 피드를 다시 동기화합니다.
