...
로그 파일 및 문제 해결 지침에 대한 자세한 내용은 [로그 검토 및 문제 해결](logging.md)을 참조하십시오.
...
- 경고는 서드파티 모듈에서 데이터 내보내기 확장과 잘못 통합되었음을 나타낼 수 있습니다. 그러나 동기화 작업은 일반적으로 계속됩니다.
...
> - [시나리오 문제 해결](troubleshooting-scenarios.md)
