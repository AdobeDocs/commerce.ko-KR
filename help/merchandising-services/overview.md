...
- [데이터 수집 API](https://developer-stage.adobe.com/commerce/services/composable-catalog/data-ingestion/using-the-api/)를 사용하여 머천다이징 서비스로 데이터 수집
- [카탈로그 관리 API](https://developer-stage.adobe.com/commerce/services/composable-catalog/admin/using-the-api/)를 사용하여 카탈로그를 관리하고 채널, 정책 및 범위를 정의합니다.
- 단일 기본 카탈로그를 가진 회사가 머천다이징 서비스 API를 사용하여 제품 데이터를 추가하고, 프로젝션을 사용하여 카탈로그를 정의하고, 헤드리스 상점 앞에 표시할 카탈로그 데이터를 검색하는 방법을 보여 주는 [자습서를 완료합니다](https://developer-stage.adobe.com/commerce/services/composable-catalog/merchandising-services-use-case/).
