...
| 설정 | 설명 |
|--- |--- |
| [범주 표시 설정](https://experienceleague.adobe.com/ko/docs/commerce-admin/catalog/categories/create/categories-display-settings) | 앵커 - `Yes` |
| [특성 속성](https://experienceleague.adobe.com/ko/docs/commerce-admin/catalog/product-attributes/create/attribute-product-create) | [카탈로그 입력 형식](https://experienceleague.adobe.com/ko/docs/commerce-admin/catalog/product-attributes/attributes-input-types) - `Yes/No`, `Dropdown`, `Multiple Select`, `Price`, `Visual swatch`(위젯 전용), `Text swatch`(위젯 전용) |
