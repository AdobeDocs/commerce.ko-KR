...
1. Facet 레이블을 편집하려면 다음 중 하나를 수행합니다.
   ...
   * [!DNL Commerce] 상점 첫 화면의 경우 [특성 레이블](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/product-attributes/product-attributes)을(를) 편집하십시오.
