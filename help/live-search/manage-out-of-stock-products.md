...
- 요청하려면 [Adobe 지원에 문의](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide){target="_blank"}하고 기능을 참조하여 재고 부족 제품을 검색 결과 끝으로 이동하십시오.
