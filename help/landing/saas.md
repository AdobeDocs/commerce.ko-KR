...
>[!WARNING]
>
> 프로덕션 [!DNL Commerce] 설치에만 **프로덕션 SaaS 데이터 공간**&#x200B;을 사용합니다. 비프로덕션 환경에서 사용하면 테스트 및 라이브 데이터(예: 스테이징 URL 또는 테스트 카탈로그 데이터)를 혼합할 수 있습니다. 이 경우 데이터 정리를 요청하려면 [지원 요청을 제출](https://experienceleague.adobe.com/ko/docs/commerce-knowledge-base/kb/overview)하십시오.
