...
라이선스 소유자가 아닌 경우 스토어에 대한 Commerce 라이선스를 소유한 사람 또는 팀으로부터 Commerce API 키를 가져와야 합니다.

>[!NOTE]
>
>API 키는 라이선스 소유자만 생성할 수 있습니다. 다른 사용자가 생성할 수 있도록 하는 공유 액세스 기능은 없습니다.
...
| 서비스 | 가용성 |
| ---|--- |
| Adobe AI에서 제공하는 [[!DNL Product Recommendations]](/help/product-recommendations/overview.md) | Adobe Commerce |
| Adobe AI에서 제공하는 [[!DNL Live Search]](/help/live-search/overview.md) | Adobe Commerce |
